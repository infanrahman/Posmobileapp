...
const arabic = <String, String>{
  ...
  'Resume held sale': 'استئناف البيع المعلق',
  'No held sales': 'لا توجد مبيعات معلقة',
  'Hold an unfinished cart from the new sale screen.':
      'علّق سلة غير مكتملة من شاشة البيع الجديد.',
  'Quotations': 'عروض الأسعار',
  'Save quotation': 'حفظ عرض السعر',
  'Convert quotation': 'تحويل عرض السعر',
  'No quotations yet': 'لا توجد عروض أسعار بعد',
  'Save a quotation from the new sale screen.':
      'احفظ عرض سعر من شاشة البيع الجديد.',
  'Purchase orders': 'طلبات الشراء',
  'Prepare orders and convert to purchases': 'جهّز الطلبات وحولها إلى مشتريات',
  'Save purchase order': 'حفظ طلب الشراء',
  'Receive purchase order': 'استلام طلب الشراء',
  'No purchase orders': 'لا توجد طلبات شراء',
  'Save an order from the new purchase screen.':
      'احفظ طلباً من شاشة الشراء الجديد.',
  'Customer statement': 'كشف حساب العميل',
  'Supplier statement': 'كشف حساب المورد',
  'Closing balance: {amount}': 'الرصيد الختامي: {amount}',
  'Export PDF': 'تصدير PDF',
  'Export CSV': 'تصدير CSV',
  'Statement exported': 'تم تصدير كشف الحساب',
  'Could not export statement.': 'تعذر تصدير كشف الحساب.',
  'No statement entries': 'لا توجد قيود في كشف الحساب',
  ...
  'Debit (SAR)': 'مدين (ر.س)',
  'Credit (SAR)': 'دائن (ر.س)',
  'Balance (SAR)': 'الرصيد (ر.س)',
  'Sale': 'بيع',
  'Sales return': 'مرتجع بيع',
  'Sale cancellation': 'إلغاء بيع',
  'Customer payment': 'دفعة عميل',
  'Customer refund': 'مبلغ مسترد للعميل',
  'Purchase': 'شراء',
  'Purchase return': 'مرتجع شراء',
  'Supplier payment': 'دفعة مورد',
  'Supplier refund': 'مبلغ مسترد من المورد',
  'statement': 'كشف حساب',
  'Item discount': 'خصم الصنف',
  'Item discounts': 'خصومات الأصناف',
  'Fixed SAR': 'مبلغ ثابت',
  'Percentage': 'نسبة مئوية',
  'Discount (%)': 'الخصم (%)',
  'Enter a percentage from 0 to 100.': 'أدخل نسبة من 0 إلى 100.',
  'Print thermal receipt': 'طباعة إيصال حراري',
  'Could not open the phone print service.': 'تعذر فتح خدمة الطباعة في الهاتف.',
  'Cancel sale': 'إلغاء البيع',
  'Cancelled': 'ملغى',
  'Cancelled sale • stock restored': 'بيع ملغى • تمت إعادة المخزون',
  'Cancellation reason': 'سبب الإلغاء',
  'Cancellation refund method': 'طريقة رد مبلغ الإلغاء',
  'Sale cancelled and stock restored.': 'تم إلغاء البيع وإعادة المخزون.',
  'Vans and salespeople': 'السيارات ومندوبي المبيعات',
  'Manage route team profiles': 'إدارة ملفات فريق المسارات',
  'Add van': 'إضافة سيارة',
  'Edit van': 'تعديل السيارة',
  'Van name': 'اسم السيارة',
  'Salesperson': 'مندوب المبيعات',
  'Van / salesperson': 'السيارة / مندوب المبيعات',
  'No salesperson': 'لا يوجد مندوب',
  'A van with this name already exists.': 'توجد سيارة بهذا الاسم بالفعل.',
  'ZATCA invoice status': 'حالة فاتورة هيئة الزكاة والضريبة والجمارك',
  'Phase 1 QR and Phase 2 readiness':
      'رمز المرحلة الأولى والاستعداد للمرحلة الثانية',
  'Phase 1 QR enabled': 'رمز QR للمرحلة الأولى مفعل',
  'Phase 1 QR needs VAT number': 'رمز المرحلة الأولى يحتاج الرقم الضريبي',
